...
📊 Passionate about Full-Stack Web Development, Machine Learning, Data Analysis, and Problem-Solving.
🛠️ Proficient with tools like Git/GitHub, Docker, AWS, VS Code, and IntelliJ IDEA.
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Projects
1. Online Grocery System | Senior Project
Technologies: TypeScript, C#, HTML, SCSS, Angular, .NET, MongoDB
Developed a responsive web application for online grocery shopping, ensuring a seamless user experience.
Integrated frontend (Angular) and backend (.NET C#) with MongoDB for efficient data management.

2. Machine Learning Model for Predictive Analysis
Technologies: TensorFlow, scikit-learn, Pandas, NumPy, Matplotlib
Built and trained a predictive model to analyze datasets and forecast trends with 85% accuracy.
Cleaned and preprocessed data, and visualized results using Matplotlib.

3. Personal Portfolio Website
Technologies: React, Node.js, MongoDB, AWS
Designed and deployed a dynamic portfolio website with responsive design principles
Hosted on AWS and managed version control using Git/GitHub.
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Technical Skills
...
🎖️ Selected for the President’s List at the University of Central Missouri.
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Let’s Connect!
